...
from api.permissions import InsAdminOrReadOnly
...
class ProductViewSet(ModelViewSet):
    ...
    - Allow autherticated admin to create, update, delete the products
    - Allow users to brows the and filter the products
    - Support searching by name , category, description
    - Support oreding by price and date
    """
    ...
    def create(self, request, *args, **kwargs):
        """Only autherticated admin can create product"""
